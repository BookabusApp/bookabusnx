...
import 'package:graphql/client.dart' as _i16;
...
import 'package:rider_flutter/core/blocs/auth_bloc.dart' as _i76;
import 'package:rider_flutter/core/blocs/location.dart' as _i90;
import 'package:rider_flutter/core/blocs/place_lookup.dart' as _i95;
import 'package:rider_flutter/core/blocs/route.dart' as _i56;
import 'package:rider_flutter/core/blocs/settings.dart' as _i61;
import 'package:rider_flutter/core/datasources/geo_datasource.dart' as _i86;
...
import 'package:rider_flutter/core/datasources/geo_datasource.prod.dart'
    as _i88;
import 'package:rider_flutter/core/datasources/graphql_datasource.dart' as _i17;
...
import 'package:rider_flutter/core/datasources/location_datasource.prod.dart'
    as _i24;
import 'package:rider_flutter/core/datasources/upload_datasource.dart' as _i65;
...
import 'package:rider_flutter/core/repositories/firebase_repository.prod.dart'
    as _i85;
import 'package:rider_flutter/core/repositories/order_repository.dart' as _i35;
...
import 'package:rider_flutter/core/repositories/profile_repository.prod.dart'
    as _i43;
import 'package:rider_flutter/core/repositories/wallet_repository.dart' as _i70;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i9.CouponRepository>(
      () => _i10.CouponRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i11.FavoriteLocationsDesktopMapCubit>(
        () => _i11.FavoriteLocationsDesktopMapCubit());
    gh.lazySingleton<_i12.FavoriteLocationsRepository>(
      () => _i13.FavoriteLocationsRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i14.FirebaseRepository>(
      () => _i15.FirebaseRepositoryMock(),
      registerFor: {_dev},
    );
    gh.factory<_i16.GraphQLClient>(() => serviceModule.create());
    gh.lazySingleton<_i17.GraphqlDatasource>(() => _i18.GraphqlDatasourceImpl(
          client: gh<_i16.GraphQLClient>(),
          connectivity: gh<_i8.Connectivity>(),
        ));
    gh.lazySingleton<_i19.HomeRepository>(
      () => _i20.HomeRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i19.HomeRepository>(
      () => _i21.HomeRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i22.LocationDatasource>(
      () => _i23.LocationDatasourceImpl(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i22.LocationDatasource>(
    ...
    gh.lazySingleton<_i26.NewOrderRepository>(
      () => _i27.NewOrderRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i26.NewOrderRepository>(
      () => _i28.NewOrderRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.singleton<_i29.OnboardingCubit>(_i29.OnboardingCubit());
    gh.lazySingleton<_i30.OrderPreviewArgsCubit>(
        () => _i30.OrderPreviewArgsCubit());
    gh.lazySingleton<_i31.OrderPreviewOptionsCubit>(
        () => _i31.OrderPreviewOptionsCubit());
    gh.lazySingleton<_i32.OrderPreviewRepository>(
      () => _i33.OrderPreviewRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i32.OrderPreviewRepository>(
      () => _i34.OrderPreviewRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i35.OrderRepository>(
      () => _i36.OrderRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i35.OrderRepository>(
      () => _i37.OrderRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i38.PaymentMethodsRepository>(
      () => _i39.PaymentMethodsRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i38.PaymentMethodsRepository>(
      () => _i40.PaymentMethodsRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i41.ProfileRepository>(
      () => _i42.ProfileRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i41.ProfileRepository>(
      () => _i43.ProfileRepositoryProd(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i44.ProfileRepository>(
      () => _i45.ProfileRepositoryProd(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i44.ProfileRepository>(
      () => _i46.ProfileRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i47.RateOrderRepository>(
      () => _i48.RateOrderRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i47.RateOrderRepository>(
      () => _i49.RateOrderRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i50.RedeemGiftCardRepository>(
      () => _i51.RedeemGiftCardRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i50.RedeemGiftCardRepository>(
      () => _i52.RedeemGiftCardRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i53.RideHistoryRepository>(
      () => _i54.RideHistoryRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i53.RideHistoryRepository>(
      () => _i55.RideHistoryRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i56.RouteCubit>(() => _i56.RouteCubit());
    gh.lazySingleton<_i57.ScheduledRidesRepository>(
      () => _i58.ScheduledRidesRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i57.ScheduledRidesRepository>(
      () => _i59.ScheduledRidesRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i60.SelectedLocationFieldCubit>(
        () => _i60.SelectedLocationFieldCubit());
    gh.singleton<_i61.SettingsCubit>(_i61.SettingsCubit());
    gh.lazySingleton<_i62.TrackOrderRepository>(
      () => _i63.TrackOrderRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i62.TrackOrderRepository>(
      () => _i64.TrackOrderRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i65.UploadDatasource>(() => _i66.UploadDatasourceImpl());
    gh.lazySingleton<_i67.WalletRepository>(
      () => _i68.WalletRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i67.WalletRepository>(
      () => _i69.WalletRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i70.WalletRepository>(
      () => _i71.WalletRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i70.WalletRepository>(
      () => _i72.WalletRepositoryMock(),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i73.AddFavoriteLocationCubit>(() =>
        _i73.AddFavoriteLocationCubit(gh<_i12.FavoriteLocationsRepository>()));
    gh.lazySingleton<_i74.AnnouncementsBloc>(
        () => _i74.AnnouncementsBloc(gh<_i3.AnnouncementsRepository>()));
    gh.lazySingleton<_i3.AnnouncementsRepository>(
      () => _i75.AnnouncementsRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i76.AuthBloc>(
        () => _i76.AuthBloc(gh<_i41.ProfileRepository>()));
    gh.lazySingleton<_i6.AuthRepository>(
      () => _i77.LoginRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i78.CancelReasonCubit>(
        () => _i78.CancelReasonCubit(gh<_i62.TrackOrderRepository>()));
    gh.lazySingleton<_i9.CouponRepository>(
      () => _i79.CouponRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i80.DestinationSuggestionsCubit>(
        () => _i80.DestinationSuggestionsCubit(gh<_i26.NewOrderRepository>()));
    gh.lazySingleton<_i81.EditFavoriteLocationCubit>(() =>
        _i81.EditFavoriteLocationCubit(gh<_i12.FavoriteLocationsRepository>()));
    gh.lazySingleton<_i82.FavoriteDriversCubit>(
        () => _i82.FavoriteDriversCubit(gh<_i44.ProfileRepository>()));
    gh.lazySingleton<_i83.FavoriteLocationsCubit>(() =>
        _i83.FavoriteLocationsCubit(gh<_i12.FavoriteLocationsRepository>()));
    gh.lazySingleton<_i12.FavoriteLocationsRepository>(
      () => _i84.FavoriteLocationsRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i14.FirebaseRepository>(
      () => _i85.FirebaseRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i86.GeoDatasource>(
      () => _i87.GeoDatasourceImpl(gh<_i22.LocationDatasource>()),
      registerFor: {_dev},
    );
    gh.lazySingleton<_i86.GeoDatasource>(
      () => _i88.GeoDatasourceImpl(
        gh<_i17.GraphqlDatasource>(),
        gh<_i22.LocationDatasource>(),
      ),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i89.HomeCubit>(() => _i89.HomeCubit(
          gh<_i19.HomeRepository>(),
          gh<_i86.GeoDatasource>(),
        ));
    gh.lazySingleton<_i90.LocationCubit>(() => _i90.LocationCubit(
          gh<_i22.LocationDatasource>(),
          gh<_i86.GeoDatasource>(),
        ));
    gh.lazySingleton<_i91.OrderPreviewCubit>(() => _i91.OrderPreviewCubit(
          gh<_i35.OrderRepository>(),
          gh<_i32.OrderPreviewRepository>(),
          gh<_i14.FirebaseRepository>(),
        ));
    gh.lazySingleton<_i92.PayForRideCubit>(() => _i92.PayForRideCubit(
          gh<_i62.TrackOrderRepository>(),
          gh<_i70.WalletRepository>(),
        ));
    gh.lazySingleton<_i93.PaymentMethodsBloc>(
        () => _i93.PaymentMethodsBloc(gh<_i38.PaymentMethodsRepository>()));
    gh.lazySingleton<_i94.PlaceConfirmCubit>(
        () => _i94.PlaceConfirmCubit(gh<_i86.GeoDatasource>()));
    gh.lazySingleton<_i95.PlaceLookupBloc>(
        () => _i95.PlaceLookupBloc(gh<_i86.GeoDatasource>()));
    gh.lazySingleton<_i96.ProfileBloc>(
        () => _i96.ProfileBloc(gh<_i44.ProfileRepository>()));
    gh.lazySingleton<_i97.RateOrderBloc>(
        () => _i97.RateOrderBloc(gh<_i47.RateOrderRepository>()));
    gh.lazySingleton<_i98.RedeemGiftCardBloc>(
        () => _i98.RedeemGiftCardBloc(gh<_i50.RedeemGiftCardRepository>()));
    gh.lazySingleton<_i99.ReportIssueCubit>(
        () => _i99.ReportIssueCubit(gh<_i53.RideHistoryRepository>()));
    gh.lazySingleton<_i100.RideHistoryBloc>(
        () => _i100.RideHistoryBloc(gh<_i53.RideHistoryRepository>()));
    gh.lazySingleton<_i101.ScheduledRidesBloc>(
        () => _i101.ScheduledRidesBloc(gh<_i57.ScheduledRidesRepository>()));
    gh.lazySingleton<_i102.TopUpWalletBloc>(
        () => _i102.TopUpWalletBloc(gh<_i70.WalletRepository>()));
    gh.lazySingleton<_i103.TrackOrderBloc>(
      () => _i103.TrackOrderBloc(gh<_i62.TrackOrderRepository>()),
      dispose: (i) => i.dispose(),
    );
    gh.lazySingleton<_i104.WalletBloc>(
        () => _i104.WalletBloc(gh<_i67.WalletRepository>()));
    return this;
  }
}
